...
std::vector<double> HistogramProcessor::GetInitialParameters(const std::vector<double>& line, double numEntries) {
    ...
    return {numEntries, line[3], line[5], line[7], line[9], line[11], line[13], line[15]};
}
...
std::vector<std::pair<double, double>> HistogramProcessor::GetParameterLimits(const std::vector<double>& line, double numEntries) {
    ...
    return {
        {0.9 * numEntries, 1.1 * numEntries},
        {0.95 * line[3], 1.05 * line[3]},
        {0.9 * line[5], 1.1 * line[5]},
        {0.95 * line[7], 1.05 * line[7]},
        {0.9 * line[9], 1.1 * line[9]},
        {0.9 * line[11], 1.1 * line[11]},
        {0.9 * line[13], 1.1 * line[13]},
        {0.9 * line[15], 1.1 * line[15]},
    };
}
...
void HistogramProcessor::GetRange(TH1F* hist, std::vector<double>& xrange) {
    ...
    double x_min = hist->GetXaxis()->GetBinCenter(maxBin-30);
