...
int main(int argc, char **argv) {
    ...
    TString canvasName = Form("%s/CB%d_WALL%d_ROB%d_FADC_Check_result.pdf", path.c_str(),  CB,WALL, ROB);
    setupCanvas(canvas, canvasName);

    // Read lines from the input file
    std::string infile = Form("%s/CB%d_WALL%d_ROB%d_FADC_channel_check_result.txt", path.c_str(),  CB, WALL,ROB);
    ...
    std::string outfile = Form("%s/CB%d_WALL%d_ROB%d_FADC_Check_result.txt", path.c_str(),  CB, WALL,ROB);
    ...
    string newrootfile = Form("%s/CB%d_WALL%d_ROB%d_FADC_Check_result.root", path.c_str(),  CB, WALL, ROB);
