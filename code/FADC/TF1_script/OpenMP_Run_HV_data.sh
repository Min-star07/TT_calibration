...
# filename_list=(
# "LED_Wilkinson_1_cCB-42_2024-12-12_08_57_000001_hist.root"
# "LED_Wilkinson_2_cCB-42_2024-12-12_09_01_000001_hist.root"
# "LED_Wilkinson_3_cCB-42_2024-12-12_09_06_000000_hist.root"
# "LED_Wilkinson_4_cCB-42_2024-12-12_09_11_000000_hist.root"
# "LED_Wilkinson_5_cCB-42_2024-12-12_09_19_000000_hist.root"
# )


# # Define an array of filenames
filename_list=(
"LED_Wilkinson_0_cCB-42_2024-12-12_08_33_000000_hist.root"
)
# Define constants
type=HV_cal
mode=WADC
...
while IFS=$'\t' read -r current_WALL current_CB current_ROB current_FEB current_PMT current_HV current_MAX_OPERA current_MAX_JUNO _ || [[ -n "$current_WALL" ]]; do
    ...
    for file in "${filename_list[@]}"; do
        ...
        python main.py --TYPE "$type" --mode "$mode" --CB "$current_CB" --WALL "$current_WALL" --ROB "$current_ROB" --FEB "$current_FEB" --PMT "$current_PMT" --HV "$current_HV" --max_channel "$current_MAX_OPERA"
    done
