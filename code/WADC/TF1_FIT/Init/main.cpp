...
int main(int argc, char **argv) {
    ...
    TString canvasName = Form("%s/CB%d_WALL%d_ROB%d_WADC_Init_result.pdf", path.c_str(),  CB,  WALL, ROB);
    setupCanvas(canvas, canvasName);

    std::string outfile = Form("%s/CB%d_WALL%d_ROB%d_WADC_Init_result.txt", path.c_str(),  CB, WALL, ROB);
    ...
    string newrootfile = Form("%s/CB%d_WALL%d_ROB%d_WADC_Init_result.root", path.c_str(),  CB, WALL,ROB);
    cout << newrootfile << endl;

    string newrootfile_ped = Form("%s/CB%d_WALL%d_ROB%d_WADC_PED.root", path.c_str(),  CB, WALL, ROB);
