...
int main(int argc, char **argv) {
    ...
    TString canvasName = Form("%s/WALL%d_CB%d_ROB%d_WADC_Check_result.pdf", path.c_str(), WALL, CB, ROB);
    setupCanvas(canvas, canvasName);

    // Read lines from the input file
    std::string infile = Form("%s/WALL%d_CB%d_ROB%d_WADC_channel_check_result.txt", path.c_str(), WALL, CB, ROB);
    ...
    std::string outfile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Check_result.txt", path.c_str(), WALL, CB, ROB);
    ...
    string newrootfile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Check_result.root", path.c_str(), WALL, CB, ROB);
