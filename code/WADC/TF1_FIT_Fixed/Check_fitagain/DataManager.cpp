...
// 从文件中读取数据
void DataManager::saveToText(const std::string &outfile, const std::string & channel, const std::vector<double> parameters, const std::vector<double> paraerror, const double status, const std::vector<double> chi2 ){
