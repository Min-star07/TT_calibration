...
int main(int argc, char **argv) {
    ...
    TString canvasName = Form("%s/WALL%d_CB%d_ROB%d_WADC_Final_result.pdf", path.c_str(), WALL, CB, ROB);
    setupCanvas(canvas, canvasName);

    // Read lines from the input file
    std::string infile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Second_result.txt", path.c_str(), WALL, CB, ROB);
    ...
    std::string outfile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Final_result.txt", path.c_str(), WALL, CB, ROB);
    ...
    string newrootfile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Final_result.root", path.c_str(), WALL, CB, ROB);
