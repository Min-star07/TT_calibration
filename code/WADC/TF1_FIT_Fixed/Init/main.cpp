...
int main(int argc, char **argv) {
    ...
    TString canvasName = Form("%s/WALL%d_CB%d_ROB%d_WADC_Init_result.pdf", path.c_str(), WALL, CB, ROB);
    setupCanvas(canvas, canvasName);

    std::string outfile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Init_result.txt", path.c_str(), WALL, CB, ROB);
    ...
    RootfileManager reader_pede(file_ped);
   
    string newrootfile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Init_result.root", path.c_str(), WALL, CB, ROB);
    cout << newrootfile << endl;

    string newrootfile_ped = Form("%s/WALL%d_CB%d_ROB%d_WADC_PED.root", path.c_str(), WALL, CB, ROB);
