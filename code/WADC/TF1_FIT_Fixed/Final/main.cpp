...
int main(int argc, char **argv) {
    ...
    string file_ped = Form("../../../../result/WALL%d/CB%d/data/WADC/%s/%s", WALL, CB, type_default.c_str(), file_ped_default.c_str());
    string path = Form("../../../../result/WALL%d/CB%d/ROB%d/WADC/%s/HV%d", WALL, CB, ROB, type_default.c_str(), HV);
    ...
    TString canvasName = Form("%s/WALL%d_CB%d_ROB%d_WADC_Second_result.pdf", path.c_str(), WALL, CB, ROB);
    setupCanvas(canvas, canvasName);

    // Read lines from the input file
    std::string infile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Init_result.txt", path.c_str(), WALL, CB, ROB);
    ...
    std::string outfile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Second_result.txt", path.c_str(), WALL, CB, ROB);
    ...
    string newrootfile = Form("%s/WALL%d_CB%d_ROB%d_WADC_Second_result.root", path.c_str(), WALL, CB, ROB);
    ...
    for (const auto& line : lines) {
        ...
        // Update the canvas with the fitted histogram
